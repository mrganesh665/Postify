            ...
            <Grid minHeight="92vh" maxWidth="1280px" mx="auto" container spacing={2} justifyContent="center" alignItems="center" >
                <Grid item xs={6} >
                    ...
                    <Typography
                        ...
                        component="h1"
                    >Postify</Typography>
                    <Typography sx={{ color: "#797979" }} variant="body1">At Postify, our mission is to provide a dynamic and intuitive platform that empowers individuals to transform their ideas into actionable tasks.</Typography>
                ...
                <Grid item xs={6}>
                    <img style={{ width: "100%" }} src="/images/banner.jpg" alt="Postify" />
                </Grid>
            </Grid>
        </>
    )
